...
export default function ProjectsHero() {
  ...
  useGSAP(() => {
    ...
    const smokeEl = heroRef.current.querySelector(".projects-smoke-overlay");
    if (smokeEl) {
      gsap.fromTo(
        smokeEl,
        { opacity: 0.4 },
  ...
  return (
    ...
    >
      ...
      <video
        ref={smokeRef}
        className="fixed inset-0 w-full h-full object-cover mix-blend-screen opacity-[0.2] pointer-events-none z-[1] projects-smoke-overlay"
