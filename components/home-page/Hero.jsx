          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-16 md:gap-20">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-12 md:gap-16 font-mono text-[11px] sm:text-[12px]">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[#908e8b] font-sans text-[9px] sm:text-[10px] tracking-widest">{content.global.addresses.newDelhi.timezoneLabel}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-[#e6e4e2]">{newYorkTime}</span>
                <span className="text-[#908e8b] font-sans text-[9px] sm:text-[10px] tracking-widest">{content.global.addresses.newYork.timezoneLabel}</span>
              </div>
            </div>
          </div>
