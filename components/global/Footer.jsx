      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-16">
        ...
        <div className="footer-reveal flex flex-col md:flex-row justify-between items-start md:items-end gap-8 pb-12">
          ...
          <div className="relative group">
            <a href={`mailto:${siteContent.global.contactEmail}`} className="font-serif text-5xl md:text-7xl text-[#e6e4e2] hover:text-[#d4c3b3] transition-colors lowercase block relative">
              contact
          ...
          <div className="flex flex-col gap-4 justify-between">
            <div className="flex flex-col gap-3">
              ...
              <ul className="flex flex-col gap-3">
                <li>
                  <a href={siteContent.global.socials.whatsapp} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors flex items-center gap-2">
                    whatsapp
                ...
                <li>
                  <a href={siteContent.global.socials.instagram} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors flex items-center gap-2">
                    instagram
                    <svg className="w-3.5 h-3.5 fill-current text-current opacity-70" viewBox="0 0 16 16">
