...
export const siteContent = {
  ...
  company: {
    ...
    founder: {
      ...
      description: "With over two decades of engineering systems at scale, Nitish founded TMMWORLD on the principle that backend architecture should be as robust as steel, and user experiences as fluid as water. Previously leading infrastructure at global logistics firms, he now guides TMMWORLD's vision of software as an architectural craft.",
