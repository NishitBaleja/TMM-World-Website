...
export const siteContent = {
  ...
  home: {
    hero: {
      tagline: "architecting premium digital systems",
      subTitle: "we design, engineer, and scale high-concurrency cloud architectures, bespoke AI systems, and interactive frontends with absolute precision."
    },
    philosophy: {
      tagline: "engineering",
      ...
      description: "software is the operational engine of the modern digital enterprise. guided by the principles of harmony (Wa) and rigorous systems logic (Ri), we engineer resilient cloud infrastructures, high-fidelity WebGL frontends, and intelligent automation pipelines optimized for extreme scalability and performance."
    },
    services: [
      {
        num: "01",
        name: "systems architecture",
        lead: "resilient, high-concurrency cloud and database engineering.",
        description: "we engineer distributed cloud infrastructures, GraphQL API meshes, and robust database architectures optimized for sub-millisecond query response and millions of concurrent sessions using AWS, Node.js, and Kubernetes.",
      ...
      },
      {
        ...
        lead: "immersive frontends and high-fidelity user experiences.",
        description: "we build responsive web frontends using React, Next.js, and WebGL, combining fluid micro-interactions with accessible layouts. Our designs ensure digital products feel premium, load instantly, and drive conversion.",
      ...
      },
      {
        ...
        lead: "custom AI pipelines and automated data workflows.",
        description: "we deploy custom machine learning models, real-time telemetry pipelines, and automation agents using Python, PyTorch, and Kafka. We transform complex data streams into operational foresight and automated decision logic.",
    ...
    company: {
      ...
      heading: "who we are",
      paragraphs: [
        "tmmworld is a premium software engineering consultancy specializing in custom enterprise software, cloud-native systems, and high-performance user interfaces. With operational hubs in New Delhi and New York, we partner with high-growth startups and established enterprises globally.",
        "we reject cookie-cutter templates. We architect bespoke software systems and design custom technology stacks that optimize performance, increase security, and transform digital operations into high-yield assets."
      ]
    }
  },
  company: {
    basicInfo: {
      ...
      paragraph1: "TMMWORLD is a custom software engineering collective founded on the principle that digital architectures should be as resilient as physical structures and as fluid as light. We build modular backend systems and tactile frontend user interfaces optimized for high concurrency, peak performance, and long-term scalability.",
      paragraph2: "From automated local pipelines to global multi-region cloud infrastructures, we deploy custom technology stacks that optimize digital operations. We partner with modern enterprises to design, audit, and engineer reliable software architectures that deliver tangible business outcomes."
    },
    map: {
      locations: [
    ...
    founder: {
      ...
      description: "With over two decades of experience designing high-concurrency systems, Nitish founded TMMWORLD to deliver backend architectures as robust as steel and user experiences as fluid as water. Previously directing enterprise infrastructure at global logistics firms, he now shapes TMMWORLD's vision of software development as a premium craft.",
